...
<head>
    ...
    <style>
        ...
        /* 2. 컨테이너 너비를 100%로 설정하고, 내부 여백(padding)을 줄여 공간을 최대화합니다. */
        .container { 
            width: 100%; 
            max-width: 1400px; 
            margin: 0 auto; 
        ...
        /* 오류 메시지 스타일 개선: 대비를 높여 내용이 확실히 보이도록 수정 */
        .error-message {
            text-align: left;
            padding: 15px;
            background-color: #ffe0e6; /* Lightest Red/Pink background */
            border: 1px solid #dc3545; /* Red border */
            color: #dc3545; /* Red text for high visibility */
            border-radius: 8px;
            line-height: 1.6;
            font-size: 15px;
            margin-top: 20px;
...
<body>
    <div class="container">
        ...
        <div class="chart-container">
            ...
            <!-- 데이터가 없는 경우를 위해 빈 차트 영역에 메시지 표시 -->
